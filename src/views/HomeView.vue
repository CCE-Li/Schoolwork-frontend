  ...
  <!-- 头部区域 -->
   <div class="header wrapper">
    ...
    <div class="search-placeholder">
      <span class="placeholder-text">搜一搜</span>
    </div>
  </div>
      <!--购物车 -->
      <div class="cart">
      ...
      <ul>
        ...
        <li>
          <a href="#">
            ...
            <div class="txt">
              <h4>“十五五”战略与中国式现代化：新形势、新思路、新举措</h4>
              <p>￥69.80</p>
            </div>
          </a>
        </li>
    ...
    <div class="footer">
      <div class="wrapper">
        ...
        <div class="service"><ul>
          ...
          <li><h5></h5><p>物流快捷</p></li>
          <li><h5></h5><p>正版保障</p></li>
          <li><h5></h5><p>售后无忧</p></li>
        </ul></div>
        <!-- 帮助中心 -->
         <div class="help">
          <div class="left">
            ...
            <dl>
              <dt>服务热线</dt>
              <dd>客服电话 400-0000-000</dd>
              <dd>人工客服 周一至周日8：00-18：00</dd>
              <!-- 调用大模型接口 -->
              <dd><a href="#">AI客服</a></dd>
            </dl>
          </div>
...
.logo a {
  ...
  width: 230px;
  height: 69px;
  background-image: url("../images/yigou.png");
  font-size: 0;
}
...
/* 确保搜索框中的 iconfont 正确显示 */
.search .search-placeholder .iconfont {
